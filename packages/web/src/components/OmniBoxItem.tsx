...
import { IconCommonBlock, IconCommonSearch, IconCommonSql, IconCommonStory } from 'assets/icons'
        ...
        icon={
          {
            ...
            [ResultType.QUESTION]: IconCommonSql,
            [ResultType.STORY]: IconCommonStory,
