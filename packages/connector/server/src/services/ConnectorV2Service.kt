...
class ConnectorV2Service(
    private val connectorManager: ConnectorManagerV2
) : ConnectorV2CoroutineGrpc.ConnectorV2ImplBase() {
    ...
    override suspend fun getCollections(request: GetCollectionRequestV2): Collections {
    ...
    override suspend fun getCollectionSchema(request: GetCollectionSchemaRequestV2): Schema {
        return withErrorWrapper(request) { req ->
            Schema {
                addAllFields(
    ...
    override suspend fun importFromFile(request: ImportRequestV2): ImportResult {
        return withErrorWrapper(request) { req ->
            val connector = connectorManager.getConnector()
